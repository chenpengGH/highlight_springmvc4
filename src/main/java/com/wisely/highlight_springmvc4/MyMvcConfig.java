...
public class MyMvcConfig extends WebMvcConfigurerAdapter {// 2
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addViewController("/demoSse").setViewName("/demoSse");
		registry.addViewController("/page/asyncTask").setViewName("/asyncTask");
		registry.addViewController("/page/asyncSend").setViewName("/asyncSend");
	}
